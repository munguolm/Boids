...
samus = pygame.image.load("samus.png")
samusrect= samus.get_rect()
# create boids at random positions
for i in range(numBoids):
    boids.append(Boid(random.randint(0, width), random.randint(0, height)))
for i in range(numAntiBoids):
    antiBoids.append(Boid(random.randint(0, width), random.randint(0, height)))

for boid in antiBoids:
        boid.velocityX=10
        boid.velocityY=10
...
while 1:
    ...
    for boid in boids:
        ...
        for anti in antiBoids:
            distance = boid.distance(anti)
            if distance < 200:
                closeAntiBoids.append(anti)
    ...
    for boid in antiBoids:
        ...
        for otherBoid in boids:
            distance - boid.distance(otherBoid)
            if distance < 300 and distance>30:
                closeBoids.append(otherBoid)
    ...
    for boid in antiBoids:
        boidRect = pygame.Rect(samusrect)
        boidRect.x = boid.x
        boidRect.y = boid.y
        screen.blit(samus,boidRect)
